...
def updateCSV(Left_B, Front_B, Right_B, Cosine_Angle, Collision, Head_x, Head_y, Food_x, Food_y, Sugg_Direction):
    with open('SNAKE_P.csv', 'a') as snakeDB:
        snakeDB.write(
            '\n{},{},{},{},{},{},{},{},{},{}'.format(Left_B, Front_B, Right_B, Cosine_Angle, Collision, Head_x, Head_y,
                                                     Food_x, Food_y, Sugg_Direction))
    ...
    for pos in snake.getBody():
        ...
        if (counter == 0):
            ...
            if (snake.direction == 'RIGHT'):
                ...
                # Suggested Direction in which snake move for RIGHT.
                if (N == 0 and pos[1] == foodposition[1]):
                    if (F == 0):
                        D = 2
                    elif (F == 1):
                        if (L == 0):
                ...
                elif (N == 180 and pos[1] == foodposition[1]):
                    if (R == 0):
                        D = 3
                    elif (L == 0):
                        D = 1
                ...
                elif (N == 90 and pos[0] == foodposition[0] and pos[1] > foodposition[1]):
                    if (L == 0):
                        D = 1
                    elif (L == 1 and R == 1):
                        D = 2
                ...
                elif (N == 0 and pos[1] == foodposition[1] and pos[0] == foodposition[0]):
                    if (F == 0):
                        D = 2
                    elif (R == 0):
                        D = 3
            ...
            if (snake.direction == 'LEFT'):
                ...
                # Suggested Direction in which snake move for LEFT.
                if (N == 0 and pos[1] == foodposition[1]):
                    if (F == 0):
                        D = 2
                    elif (F == 1):
            ...
            if (snake.direction == 'UP'):
                ...
                # Suggested Direction in which snake move for LEFT.
                if (N == 0 and pos[0] == foodposition[0]):
                    if (F == 0):
                        D = 2
                    elif (F == 1):
                        if (L != 1):
                ...
                elif (N == 180 and pos[0] == foodposition[0]):
                    if (R == 0):
                        D = 3
                    elif (L == 0):
                        D = 1
                ...
                elif (N == 90 and pos[1] == foodposition[1] and pos[0] > foodposition[0]):
                    if (L == 0):
                        D = 1
                    elif (L == 1 and R == 1):
                        D = 2
            ...
            if (snake.direction == 'DOWN'):
                ...
                # Suggested Direction in which snake move for DOWN.
                if (N == 0 and pos[0] == foodposition[0]):
                    if (F == 0):
                        D = 2
                    elif (F == 1):
        ...
        ###################################################################################################################################
            ...
            if pos[2] != snake.body[counter - 1][2]:
                ...
                if pos[2] == 'LEFT' and snake.body[counter - 1][2] == 'DOWN' or pos[2] == 'UP' and \
                        snake.body[counter - 1][2] == 'RIGHT':
                    gameWindow.blit(Bend_1, (pos[0], pos[1]))

                elif pos[2] == 'UP' and snake.body[counter - 1][2] == 'LEFT' or pos[2] == 'RIGHT' and \
                        snake.body[counter - 1][2] == 'DOWN':
                    gameWindow.blit(Bend_2, (pos[0], pos[1]))

                elif pos[2] == 'LEFT' and snake.body[counter - 1][2] == 'UP' or pos[2] == 'DOWN' and \
                        snake.body[counter - 1][2] == 'RIGHT':
                    gameWindow.blit(Bend_4, (pos[0], pos[1]))

                elif pos[2] == 'RIGHT' and snake.body[counter - 1][2] == 'UP' or pos[2] == 'DOWN' and \
                        snake.body[counter - 1][2] == 'LEFT':
