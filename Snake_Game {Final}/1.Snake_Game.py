    ...
    for pos in snake.getBody():
        ...
        if (counter == 0):
            ...
            if (snake.direction == 'RIGHT'):
                ...
                if (N == 0 and pos[0] < foodposition[0] and pos[1] == foodposition[1]):
                    D = 2

                elif (N == 180 and pos[0] > foodposition[0] and pos[1] == foodposition[1]):
                    values = list([1, 3])
            ...
            if (snake.direction == 'UP'):
                ...
                # Suggested Direction in which snake move for LEFT.
                if (N == 0 and pos[1] > foodposition[1] and pos[0] == foodposition[0]):
                    D = 2

                elif (N == 180 and pos[1] < foodposition[1] and pos[0] == foodposition[0]):
                    values = list([1, 3])
                    D = random.choice(values)
