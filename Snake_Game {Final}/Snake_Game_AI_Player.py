...
def updateCSV(Left_B,Front_B,Right_B,Cosine_Angle,Collision,Head_x,Head_y,Food_x,Food_y,Sugg_Direction):
    with open('SNAKE_A.csv', 'a') as snakeDB:
...
bg_image1 = pygame.image.load('bgg.png')
...
def gameRun():
    ...
    #for i in range(0, len(snake.body)):
        #if(snake.body[i][0] != food.position[0] and snake.body[i][1] != food.position[1]):
